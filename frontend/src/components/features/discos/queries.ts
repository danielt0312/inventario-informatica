...
import type { Disco, DiscoCapacidad, DiscoFactorForma, DiscoInterfaz, DiscoTipo } from "@/types/articulos/discos";
...
const options = queryOptions({
    queryKey: ['discos'],
    queryFn: () => api.get<TResponse<Disco[]>>('api/discos')
        .then(r => r.data.data)
});
